...
>(
  (
    ...
    // Read sidebar state from cookie if present
    ...
    const initialOpen = (() => {
      if (typeof window !== "undefined") {
        const cookieValue = getSidebarOpenFromCookie();
